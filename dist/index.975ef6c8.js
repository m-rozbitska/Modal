...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function AssignNumber(e) {
        if (evaluation.length <= 1) {
            first_number = first_number == "0" ? e.target.getAttribute("data-value") : first_number + e.target.getAttribute("data-value");
        ...
        if (evaluation.length >= 2) {
            second_number = second_number == "0" ? e.target.getAttribute("data-value") : second_number + e.target.getAttribute("data-value");
    ...
    function Render(e) {
        ...
        last_operator_button && last_operator_button.classList.remove("selected_operation");
        new_operator_button && new_operator_button.classList.add("selected_operation");
        ...
        if (result.toString().length > 9) screen.textContent = parseFloat(result).toPrecision(3);
        else screen.textContent = result;
        evaluation.length == "0" ? clear_button.textContent = "AC" : clear_button.textContent = "C";
    }
}) // let firstNumber = "0";
 // let secondNumber = "0";
 // let result = "0";
